...
def card(app):
    ...
    # The subscription trial is already the price tag's own line; printing it
    # twice on one card would read as two different offers.
    if free and free != apps_data.SUB_TRIAL:
